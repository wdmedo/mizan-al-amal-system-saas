...
ALTER TABLE public.expenses ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_expenses" ON public.expenses;
CREATE POLICY "users_select_own_expenses" ON public.expenses FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_expenses" ON public.expenses FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_expenses" ON public.expenses FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_expenses" ON public.expenses FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.pending_customers ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_pending_customers" ON public.pending_customers;
CREATE POLICY "users_select_own_pending_customers" ON public.pending_customers FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_pending_customers" ON public.pending_customers FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_pending_customers" ON public.pending_customers FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_pending_customers" ON public.pending_customers FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.payments ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_payments" ON public.payments;
CREATE POLICY "users_select_own_payments" ON public.payments FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_payments" ON public.payments FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_payments" ON public.payments FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_payments" ON public.payments FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.completed_customers ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_completed_customers" ON public.completed_customers;
CREATE POLICY "users_select_own_completed_customers" ON public.completed_customers FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_completed_customers" ON public.completed_customers FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_completed_customers" ON public.completed_customers FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_completed_customers" ON public.completed_customers FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.employees ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_employees" ON public.employees;
CREATE POLICY "users_select_own_employees" ON public.employees FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_employees" ON public.employees FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_employees" ON public.employees FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_employees" ON public.employees FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.coverages ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_coverages" ON public.coverages;
CREATE POLICY "users_select_own_coverages" ON public.coverages FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_coverages" ON public.coverages FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_coverages" ON public.coverages FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_coverages" ON public.coverages FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.accounts ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_accounts" ON public.accounts;
CREATE POLICY "users_select_own_accounts" ON public.accounts FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_accounts" ON public.accounts FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_accounts" ON public.accounts FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_accounts" ON public.accounts FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.employee_transactions ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_employee_transactions" ON public.employee_transactions;
CREATE POLICY "users_select_own_employee_transactions" ON public.employee_transactions FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_employee_transactions" ON public.employee_transactions FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_employee_transactions" ON public.employee_transactions FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_employee_transactions" ON public.employee_transactions FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.coverage_transactions ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_coverage_transactions" ON public.coverage_transactions;
CREATE POLICY "users_select_own_coverage_transactions" ON public.coverage_transactions FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_coverage_transactions" ON public.coverage_transactions FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_coverage_transactions" ON public.coverage_transactions FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_coverage_transactions" ON public.coverage_transactions FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.capital_entries ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_capital_entries" ON public.capital_entries;
CREATE POLICY "users_select_own_capital_entries" ON public.capital_entries FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_capital_entries" ON public.capital_entries FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_capital_entries" ON public.capital_entries FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_capital_entries" ON public.capital_entries FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.daily_visits ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_daily_visits" ON public.daily_visits;
CREATE POLICY "users_select_own_daily_visits" ON public.daily_visits FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_daily_visits" ON public.daily_visits FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_daily_visits" ON public.daily_visits FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_daily_visits" ON public.daily_visits FOR DELETE TO authenticated USING (user_id = auth.uid());

ALTER TABLE public.customer_followups ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "public_all_customer_followups" ON public.customer_followups;
CREATE POLICY "users_select_own_customer_followups" ON public.customer_followups FOR SELECT TO authenticated USING (user_id = auth.uid());
CREATE POLICY "users_insert_own_customer_followups" ON public.customer_followups FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_update_own_customer_followups" ON public.customer_followups FOR UPDATE TO authenticated USING (user_id = auth.uid()) WITH CHECK (user_id = auth.uid());
CREATE POLICY "users_delete_own_customer_followups" ON public.customer_followups FOR DELETE TO authenticated USING (user_id = auth.uid());
